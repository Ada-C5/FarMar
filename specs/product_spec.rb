...
describe FarMar::Product do
  ...
  describe "FarMar::Product#self.find" do
    it "should return 'Depressed Beets' as Product name when self.find called by id 30" do
      FarMar::Product.find(30).name.must_equal "Depressed Beets"
    end

    it "should return 'ID not found!' when self.find called by id 9000" do
      FarMar::Product.find(9000).must_equal "ID not found!"
    end
