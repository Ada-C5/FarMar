...
describe FarMar::Market do
  ...
  describe "Market#markets_with_nil" do
    it "stores markets with missing info into an array" do
      ...
      missinginfo.last.must_be_instance_of String
      missinginfo.last[0].to_i.must_be_instance_of Fixnum
  ...
  describe "Market#self.all" do
    ...
    it "has objects with the correct data" do
      ...
      all_markets[13].county.must_equal "Washington"
      all_markets[13].state.must_equal "Wisconsin"
      all_markets[13].zip.must_equal "53027"
    end
  end
  ...
  describe "Market#self.search(search_term)" do
    it "returns an array of markets that match the search term" do
